...
prepareXP() {
  ...
  {       echo "Windows Registry Editor Version 5.00"
          ...
          echo "\"SCRNSAVE.EXE\"=\"(none)\""
          echo ""
          echo "[HKEY_USERS\.DEFAULT\Software\Policies\Microsoft\Windows\Control Panel\Desktop]"
  ...
  {       echo "[COMMANDS]"
          ...
          echo "\"POWERCFG.EXE /NUMERICAL /CHANGE 0 /monitor-timeout-ac 120"
          echo "\"POWERCFG.EXE /NUMERICAL /CHANGE 0 /disk-timeout-ac 120"
          echo "\"POWERCFG.EXE /NUMERICAL /CHANGE 0 /standby-timeout-ac 0"
          echo "\"POWERCFG.EXE /NUMERICAL /SETACTIVE 0"
