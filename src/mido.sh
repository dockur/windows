...
getWindows() {
  ...
  case "${version,,}" in
    "win2008r2" | "win7${PLATFORM,,}-enterprise"* | "win81${PLATFORM,,}-enterprise"* | "win11${PLATFORM,,}-enterprise-iot"* | "win11${PLATFORM,,}-enterprise-ltsc"* )
      if [[ "${lang,,}" != "en" ]] && [[ "${lang,,}" != "en-"* ]]; then
  ...
  case "${version,,}" in
    ...
    "win2025-eval" | "win2022-eval" | "win2019-eval" | "win2016-eval" | "win2012r2-eval" )
      download_windows_eval "$version" "$lang" "$edition" && return 0
      ;;
    "win7${PLATFORM,,}-enterprise"* | "win81${PLATFORM,,}-enterprise"* | "win2008r2" )
      ;;
